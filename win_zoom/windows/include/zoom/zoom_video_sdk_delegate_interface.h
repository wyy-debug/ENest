...
#include "include/helpers/zoom_video_sdk_phone_helper_interface.h"
#include "include/helpers/zoom_video_sdk_recording_helper_interface.h"
#include "include/helpers/zoom_video_sdk_audio_setting_interface.h"
#include "include/helpers/zoom_video_sdk_user_helper_interface.h"
...
#include "include/helpers/zoom_video_sdk_livestream_helper_interface.h"
#include "include/helpers/zoom_video_sdk_livetranscription_helper_interface.h"
#include "include/helpers/zoom_video_sdk_chat_helper_interface.h"
#include "include/helpers/zoom_video_sdk_network_connection_helper_interface.h"
#include "include/helpers/zoom_video_sdk_crc_helper_interface.h"
...
public:
	...
	/// \brief Callback event that binds the incoming live stream.
	...
	/// \brief Callback event that unbinds the incoming live stream.
	/// \param bSuccess true: success, otherwise false.
	/// \param strStreamKeyID Corresponding stream key ID.
	virtual void onUnbindIncomingLiveStreamResponse(bool bSuccess, const zchar_t* strStreamKeyID) = 0;

	/// \brief Callback event that gets the streams status.
	/// \param bSuccess true: success, otherwise false.
	...
	/// \brief Callback event that starts the bound stream.
	/// \param bSuccess true: success, otherwise false.
	/// \param strStreamKeyID Corresponding stream key ID.
	virtual void onStartIncomingLiveStreamResponse(bool bSuccess, const zchar_t* strStreamKeyID) = 0;

	/// \brief Callback event that stops the bound stream.
	/// \param bSuccess true: success, otherwise false.
	/// \param strStreamKeyID Corresponding stream key ID.
