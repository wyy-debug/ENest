...
export const proto = $root.proto = (() => {
    ...
    proto.HeartbeatMessage = (function() {
        ...
        HeartbeatMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.HeartbeatMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        HeartbeatMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.HeartbeatMessage)
                return object;
            let message = new $root.proto.HeartbeatMessage();
            if (object.timestamp != null)
                if ($util.Long)
                    (message.timestamp = $util.Long.fromValue(object.timestamp)).unsigned = false;
                else if (typeof object.timestamp === "string")
    ...
    proto.AuthMessage = (function() {
        ...
        AuthMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.AuthMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        AuthMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.AuthMessage)
                return object;
            let message = new $root.proto.AuthMessage();
    ...
    proto.RegisterMessage = (function() {
        ...
        RegisterMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.RegisterMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        RegisterMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.RegisterMessage)
                return object;
            let message = new $root.proto.RegisterMessage();
            if (object.username != null)
                message.username = String(object.username);
            if (object.password != null)
                message.password = String(object.password);
    ...
    proto.ChatMessage = (function() {
        ...
        ChatMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.ChatMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ChatMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.ChatMessage)
                return object;
            let message = new $root.proto.ChatMessage();
    ...
    proto.SystemMessage = (function() {
        ...
        SystemMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.SystemMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        SystemMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.SystemMessage)
                return object;
            let message = new $root.proto.SystemMessage();
            if (object.type != null)
    ...
    proto.StudyRoomMessage = (function() {
        ...
        StudyRoomMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.StudyRoomMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        StudyRoomMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.StudyRoomMessage)
                return object;
            let message = new $root.proto.StudyRoomMessage();
    ...
    proto.FriendMessage = (function() {
        ...
        FriendMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.FriendMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        FriendMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.FriendMessage)
                return object;
            let message = new $root.proto.FriendMessage();
            switch (object.operation) {
            default:
                if (typeof object.operation === "number") {
                    message.operation = object.operation;
    ...
    proto.ProfileMessage = (function() {
        ...
        ProfileMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.ProfileMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ProfileMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.ProfileMessage)
                return object;
            let message = new $root.proto.ProfileMessage();
            switch (object.operation) {
            default:
                if (typeof object.operation === "number") {
                    message.operation = object.operation;
    ...
    proto.ErrorMessage = (function() {
        ...
        ErrorMessage.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.proto.ErrorMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ErrorMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.proto.ErrorMessage)
                return object;
            let message = new $root.proto.ErrorMessage();
            if (object.code != null)
